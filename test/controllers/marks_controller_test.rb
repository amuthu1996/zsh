...
class MarksControllerTest < ActionController::TestCase
  ...
  test "should create mark" do
    assert_difference('Mark.count') do
      post :create, mark: { ann: @mark.ann, half: @mark.half, quarter: @mark.quarter, sid: @mark.sid, sub_id: @mark.sub_id }
    end
  ...
  test "should update mark" do
    patch :update, id: @mark, mark: { ann: @mark.ann, half: @mark.half, quarter: @mark.quarter, sid: @mark.sid, sub_id: @mark.sub_id }
    assert_redirected_to mark_path(assigns(:mark))
  end
